...
public:
	...
	static void RenderTrail(RwIm2DVertex *quad, RwRaster *ghost, const float *keep, const float *pass, const float *white, float strength, RwIm2DVertex *quad2 = nil, const float *keep2 = nil, RwRaster *fresh = nil);
