...
ConvertingTexturesScreen(uint32 num, uint32 count, const char *text)
{
	...
	CSprite2d::DrawRect(CRect(SCREEN_SCALE_FROM_LEFT(200.0f), SCREEN_SCALE_Y(240.0f), (SCREEN_SCALE_FROM_RIGHT(200.0f) - SCREEN_SCALE_FROM_LEFT(200.0f)) * ((float)num / (float)count) + SCREEN_SCALE_FROM_LEFT(200.0f), SCREEN_SCALE_Y(248.0f)), CRGBA(97, 194, 247, 255));
