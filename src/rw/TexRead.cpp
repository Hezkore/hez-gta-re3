...
ConvertingTexturesScreen(uint32 num, uint32 count, const char *text)
{
	...
	CSprite2d::DrawRect(CRect(SCREEN_SCALE_FROM_LEFT(200.0f), SCREEN_SCALE_Y(240.0f), SCREEN_SCALE_FROM_RIGHT(200.0f), SCREEN_SCALE_Y(248.0f)), CRGBA(64, 64, 64, 255));
#ifdef FIX_BUGS
	CSprite2d::DrawRect(CRect(SCREEN_SCALE_FROM_LEFT(200.0f), SCREEN_SCALE_Y(240.0f), (SCREEN_SCALE_FROM_RIGHT(200.0f) - SCREEN_SCALE_FROM_LEFT(200.0f)) * ((float)num / (float)count) + SCREEN_SCALE_FROM_LEFT(200.0f), SCREEN_SCALE_Y(248.0f)), CRGBA(255, 150, 225, 255));
#else
	CSprite2d::DrawRect(CRect(SCREEN_SCALE_FROM_LEFT(200.0f), SCREEN_SCALE_Y(240.0f), (SCREEN_SCALE_FROM_RIGHT(200.0f) - SCREEN_SCALE_FROM_LEFT(200.0f)) * ((float)num / (float)count) + SCREEN_SCALE_FROM_LEFT(200.0f), SCREEN_SCALE_Y(248.0f)), CRGBA(255, 217, 106, 255));
#endif
	CSprite2d::DrawRect(CRect(SCREEN_SCALE_FROM_LEFT(120.0f), SCREEN_SCALE_Y(150.0f), SCREEN_SCALE_FROM_RIGHT(120.0f), SCREEN_HEIGHT - SCREEN_SCALE_Y(220.0f)), CRGBA(50, 50, 50, 210));
